...
class NursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nurse" do
    assert_difference('Nurse.count') do
      post nurses_url, params: { nurse: { department: @nurse.department, nurseName: @nurse.nurseName } }
    end
  ...
  test "should update nurse" do
    patch nurse_url(@nurse), params: { nurse: { department: @nurse.department, nurseName: @nurse.nurseName } }
