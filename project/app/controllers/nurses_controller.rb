class NursesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @nurse.save
        format.html { redirect_to @nurse, notice: 'Nurse was successfully added.' }
  ...
  def destroy
    @nurse.destroy
    respond_to do |format|
      format.html { redirect_to nurses_url, notice: 'Nurse was successfully deleted.' }
  ...
  private
    ...
    def nurse_params
      params.require(:nurse).permit(:nurseName, :department)
    end
end
